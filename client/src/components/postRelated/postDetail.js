...
// This is the postDetail function.
function PostDetail({ match }) {
    ...
    // This is the function to fetch the result from backend.
    const fetchItem = async () => {
        const fetchItem = await fetch('/postdetail',
            {
                // This will send AUthorization 'jwt' and p as the post ID as the header.
                headers: {
        ...
        // This is used to 'set' the post item.
        setItem(item.post);

        // This is used to 'set' the username.
        setUsername(item.post.username)

        // This is used to get the likes number.
        setLikes(item.post.likes)

        // This is used to get the dislikes number.
        setDislikes(item.post.dislikes)

        // This is used to get the comments.
        setComments(item.post.comments);
    }

    // This is the function that call '/like' API.
    function likePost(id) {
        fetch('/like', {
            method: "PUT",

            // This part will send the content type and authorization as the header.
            headers: {
                "Content-Type": "application/json",
                "Authorization": "Bearer " + localStorage.getItem("jwt")
            },

            // This part will send the post ID as the request body.
            body: JSON.stringify({
                postId: id
            })
        }).then(res => res.json())
    ...
    // This is the function that call '/dislike' API.
    ...
    // This is the function that call '/comment' API.
    const makeComment = (comment, postId) => {
        fetch('/comment', {
            ...
            // This part will send the post ID and also the comment as the request body.
            body: JSON.stringify({
                postId,
                comment
            })
    ...
    // This part call the 'deletepost/:Post ID' API to delete the post.
    ...
    // This part call the 'deletecomment/: Comment ID' API to delete the comment.
    ...
    // This is the 'HTML' part of post detail page.
    return (
        <div>
            {NavBar()}
            <div className="container-md mt-5 bg-color pb-5 text-light">
                ...
                <div className="d-flex justify-content-center mb-3">
                    {// This is used to set the image size without distoring the image.
                    ...
                    <div className="d-flex justify-content-center w-75">
                        ...
                        <div className="d-flex flex-row w-25">
                            <div className="d-flex p-2 mr-3 ">
                                {// This is to check whether the user already like the post or not
                                    // If yes, it will make the like button blue.
                            ...
                            <div className="d-flex p-2 ml-3">
                                ...
                                {// This is to check whether the user already dislike the post or not
                                    // If yes, it will make the dislike button blue.
...
// This is the function to show the navigation bar.
function NavBar() {
    const { state, dispatch } = useContext(UserContext)
